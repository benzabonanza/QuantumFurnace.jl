...
#         precomputed_data.transition = transition
...
#         precomputed_data.t0 = t0
#         precomputed_data.f_minus = f_minus
#         precomputed_data.f_plus = f_plus
#         precomputed_data.time_labels = time_labels
#         precomputed_data.oft_time_labels = oft_time_labels
#     end
...
# # Arpack eigs
# @time eigvals_near_zero, eigvecs_near_zero = eigs(linmap, nev=2, which=:SM, tol=1e-6)
