function construct_lindbladian(jumps::Vector{JumpOp}, config::Config{Lindbladian}, hamiltonian::HamHam;
    ...
    ws = Workspace{Lindbladian, typeof(config.domain), typeof(config.construction), T}(
        ...
        nothing, nothing, nothing, nothing, nothing, nothing, nothing, nothing,  # domain-specific (oft_nufft_prefactors, oft_prefactors_energy, bohr_alpha, bohr_keys, bohr_is, bohr_js, b_minus, b_plus)
